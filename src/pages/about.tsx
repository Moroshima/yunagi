      ...
      <main className={styles.main}>
        <div className={styles["space-limit"]}>
          ...
          <div className={styles.content}>
            ...
            <p>
              其实我偏爱旧日本海军，很大程度上即是因为其在舰名与舰船设计上都极富日式美学——用美好的事物去称呼暴力且无情的战争机器，同时舰船设计思路也可以说是剑走偏锋。在当时全球海军中，日本海军可以说是将舰船设计与海军战术战法之间的整合发挥到了极致。从“樱花特攻”到“神风特攻队”以至“菊水特攻”——日本或者说大和民族从根底便透露着一隅小国执拗但狂热的军国主义与民族主义热忱。而于此对战争和暴力的美学化，我不置可否。
            </p>
            <h3>配色方案</h3>
            <p>
