        ...
        <div className={styles["space-limit"]}>
          ...
          <div className={styles.content}>
            ...
            <p>
              ...
              当然，另外很大程度上我会选择夕凪这个名字不仅是因为这是一个美好的词语，更是因为旧日本帝国海军（IJN）所建造的九艘神风级驱逐舰之一即以此命名——她也正如它的名字一般，沉没于旧日本帝国的夕凪时分（1944年8月25日）。
            </p>
            <p>
              其实我偏爱旧日本海军，很大程度上即是因为其在舰名与舰船设计上都极富日式美学——用美好的事物去称呼暴力且无情的战争机器，从“樱花特攻”到“神风特攻队”以至“菊水特攻”——日本或者说大和民族从根底便透露着一隅小国执拗但狂热的军国主义与民族主义热忱。于此对战争和暴力的美学化，我不置可否。
            </p>
            <h3>配色方案</h3>
            <p>
